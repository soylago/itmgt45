...
def savings(gross_pay, tax_rate, expenses):
    ...
    takehomepay_rounded = math.floor(takehomepay)
    return takehomepay_rounded
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    final_material = f"{remaining_material}{material_units}"
...
def interest(principal, rate, periods):
    ...
    final_value_rounded = math.floor(final_value)
